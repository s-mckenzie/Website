...
function submitForm(){
	...
	if (error){
		...
		$.post("../Site/validate_user.php", data, create_user);
...
function create_user(data, status) {
...
function scrollToError() {
	$('html, body').animate({scrollTop: ($('.error-scroll').first().offset().top - 100)} ,500); // Animation scroll to first error
}